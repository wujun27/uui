...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "myOauth@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "myOauth API";

        private String description = "myOauth API documentation";
